...
public class AppTest {
    ...
    void testFilterByAllFields() throws Exception {
        final String exampleOfQueryRequest = "/users?firstName=lee&lastName=tt&email=flow&gender=Female&profession=bio";
        MockHttpServletResponse response = mockMvc
                .perform(get(exampleOfQueryRequest))
                .andReturn()
                .getResponse();
        ...
        assertThat(actualUser.getFirstName()).isEqualTo("Lauralee");
        assertThat(actualUser.getLastName()).isEqualTo("Flowitt");
        assertThat(actualUser.getEmail()).isEqualTo("lflowitto@yolasite.com");
        assertThat(actualUser.getGender()).isEqualTo("Female");
        assertThat(actualUser.getProfession()).isEqualTo("Biostatistician IV");
    }
